# Your name: Addison Gale
# Your student id: 25003713
# Your email: addieg@umich.edu
...
class Magic_8:
    ...
    def __str__(self):
        answers = " "
        for string in self.answer_list:
            answers += string + ", "
        return answers
    ...
    def print_history(self):
        if len(self.answer_history_list) == 0: 
            ...
            for i in self.answer_history_list:
                print(i + " " + self.question_list[i] + " - " + self.answer_list[i])
